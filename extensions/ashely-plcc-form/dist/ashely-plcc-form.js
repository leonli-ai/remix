(() => {
  ...
  // node_modules/.pnpm/@shopify+ui-extensions@2024.7.0/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/components/BlockSpacer/BlockSpacer.mjs
  var BlockSpacer = createRemoteComponent("BlockSpacer");

  // node_modules/.pnpm/@shopify+ui-extensions@2024.7.0/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/components/Form/Form.mjs
  var Form = createRemoteComponent("Form");

  // node_modules/.pnpm/@shopify+ui-extensions@2024.7.0/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/components/TextField/TextField.mjs
...
${errorInfo.componentStack}`);
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1__react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/BlockSpacer/BlockSpacer.mjs
  var BlockSpacer2 = createRemoteReactComponent(BlockSpacer);

  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1__react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/Form/Form.mjs
  var Form2 = createRemoteReactComponent(Form);

  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1__react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/TextField/TextField.mjs
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1__react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/buyer-journey.mjs
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1__react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/app-metafields.mjs
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1__react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/payment-options.mjs
  ...
  // node_modules/.pnpm/@shopify+ui-extensions-react@2024.7.0_@shopify+ui-extensions@2024.7.0_react-reconciler@0.29.0_react@18.3.1__react@18.3.1/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/payment-method.mjs
  ...
  // extensions/ashely-plcc-form/src/Checkout.tsx
  var import_react17 = __toESM(require_react());
  var import_lodash = __toESM(require_lodash());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var Checkout_default = reactExtension("purchase.checkout.payment-option-item.details.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {}));
  var LOG_PREFIX = "[Checkout UI Extension]";
  function Extension() {
    var _a;
    const callId = useAttributeValues(["callId"])[0];
    const [inValidCardName, setInvalidCardName] = (0, import_react17.useState)(false);
    const [inValidCardNumber, setInvalidCardNumber] = (0, import_react17.useState)(false);
    const [cardName, setCardName] = (0, import_react17.useState)("");
    const [cardNumber, setCardNumber] = (0, import_react17.useState)("");
    ...
    const plccPaymentAppHost = (_a = setting == null ? void 0 : setting.metafield) == null ? void 0 : _a.value;
      ...
      if (callId && plccPaymentAppHost) {
        fetch(`${plccPaymentAppHost}/app/account/detail`, {
          ...
          if (account) {
            ...
            setCardNumber(account.accountNumber);
            debouncedSearch(account.accountNumber);
          }
        });
      }
    ...
    (0, import_react17.useEffect)(() => {
      var _a2;
      if (((_a2 = selectedPaymentOptions[0]) == null ? void 0 : _a2.type) !== "customOnsite") {
        updateAttribute({ key: "plcc_last4", value: "", type: "updateAttribute" });
      }
    }, [JSON.stringify(selectedPaymentOptions)]);
    const debouncedSearch = (0, import_react17.useMemo)(
    ...
    function validateCardNumber(cardNumber2) {
      let isValid = true;
      isValid = /^(585637|200|219|1234)\d{5,13}$|^1234$/.test(cardNumber2);
      return isValid;
    }
    (0, import_react17.useEffect)(() => {
      if (!cardName || !validateCardNumber(cardNumber))
        return;
      const change = {
      ...
      const applyChange = () => __async(this, null, function* () {
        try {
          const result = yield applyPaymentMethodAttributesChange(change);
    ...
    useBuyerJourneyIntercept(
      (_0) => __async(this, [_0], function* ({ canBlockProgress }) {
        var _a2;
        if ((cardName === "" || !validateCardNumber(cardNumber)) && canBlockProgress && ((_a2 = selectedPaymentOptions[0]) == null ? void 0 : _a2.type) === "customOnsite") {
          return {
            behavior: "block",
            ...
            perform: (result) => {
              if (result.behavior === "block") {
                ...
                setInvalidCardNumber(!validateCardNumber(cardNumber));
              }
            }
          };
        }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Form2, { onSubmit: () => {
    }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        TextField2,
        {
          ...
          required: true,
          onBlur: () => setInvalidCardNumber(!validateCardNumber(cardNumber)),
          onChange: (newValue) => {
...
//# sourceMappingURL=ashely-plcc-form.js.map
