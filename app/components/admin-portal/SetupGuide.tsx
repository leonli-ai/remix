...
export const SetupGuide = ({ onDismiss, onStepComplete, items }: { onDismiss: () => void, onStepComplete: (id: number) => Promise<void>, items: any[] }) => {
    ...
    <Card padding='0'>
      <Box padding='400' paddingBlockEnd='400'>
        <BlockStack>
          ...
          To configure our app, please follow the steps below. If you encounter any issues during the process or need more detailed instructions, contact {' '}
          <a className='text-blue-500' href="mailto:streamlines-support@aaxis.io">streamlines-support@aaxis.io</a>.
          </Text>
...
const SetupItem = ({
  ...
  return (
    ...
    <div className={`${expanded ? "bg-gray-100" : ""}`}>
              ...
              <Collapsible open={expanded} id={id.toString()}>
                <Box paddingBlockEnd='150' paddingInlineEnd='150'>
                  <BlockStack gap='400'>
                    ...
                    {
                      listAndButton ? (
                        listAndButton.map((item: any) => (
                         <div className='flex flex-col gap-2 ml-4' key={item.title}>
                            ...
                            </div>
                            {
                              item.props ? (
                                <div>
                                  <Button variant='primary' {...item.props}>
                                    {item.props.content}
                                  </Button>
                                </div>
                              ) : null
